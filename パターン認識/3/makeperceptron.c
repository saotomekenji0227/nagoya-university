...
int main(int argc,char* argv[]){
  ...
  int p=0;  //現在見ているパターン
  int loopnum=0; //収束するまでのステップ数記録
  double g[C]; //計算結果
  printf("正否は0で変更なし、1でいずれかの値を変更\ngの値は左から1、2、...Cの順で表示\n");
...
/*
[kenji@localhost パターン認識]$ ./a.out perceptronld.dat w.dat
正否は0で変更なし、1でいずれかの値を変更
gの値は左から1、2、...Cの順で表示
g : 9.000000 8.000000 8.000000 
パターン1 正否0

g : 11.000000 9.000000 14.000000 
パターン2 正否1

g : 12.000000 23.000000 4.000000 
パターン3 正否0

g : 15.000000 32.000000 8.000000 
パターン4 正否0

g : 18.000000 32.000000 16.000000 
パターン5 正否1

g : 17.000000 3.000000 39.000000 
パターン6 正否0

g : 10.000000 3.000000 12.000000 
パターン1 正否1

g : 16.000000 2.000000 16.000000 
パターン2 正否1

g : 18.000000 14.000000 7.000000 
パターン3 正否1

g : 8.000000 34.000000 13.000000 
パターン4 正否0

g : 13.000000 31.000000 22.000000 
パターン5 正否1

g : 14.000000 1.000000 44.000000 
パターン6 正否0

g : 9.000000 3.000000 13.000000 
パターン1 正否1

g : 15.000000 1.000000 18.000000 
パターン2 正否1

g : 13.000000 16.000000 10.000000 
パターン3 正否0

g : 16.000000 21.000000 18.000000 
パターン4 正否0

g : 22.000000 16.000000 28.000000 
パターン5 正否0

g : 22.000000 11.000000 26.000000 
パターン6 正否0

g : 13.000000 6.000000 6.000000 
パターン1 正否0

g : 16.000000 6.000000 12.000000 
パターン2 正否0
