...
while_statement
	 ...
	 {
	   generate(JMP,0,0,$2);printf("%d/n",$4); 
...
for_statement
	 ...
	 {
	   item = lookup($2);
	   generate(LOD,item->type,0,$2);
	   generate(LIT,0,0,1);
	   generate(OPR,0,0,1);
	   generate(STO,item->type,0,$2);
	   generate(JMP,0,0,$7);
	   backpatch($5,STO,item->type,0,$2);
	   backpatch($7,LOD,item->type,0,$2);
